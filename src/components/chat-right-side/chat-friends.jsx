...
import { FaPlus, FaHome, FaUser, FaKey, FaFacebookMessenger, FaGamepad, FaSmoking, FaUsers, FaShare } from 'react-icons/fa';
        ...
        return (
            <div ref={this.testRef} id="chated-side">
                <ul className={`menu ${isMenuActive ? 'active' : ''}`} onClick={this.handleToggleClick}>
                    ...
                    <li style={{ '--i': 5 }} onClick={this.activeLink}><a ><FaShare /></a> </li>
                    <li style={{ '--i': 6 }} onClick={this.activeLink}><a ><FaSmoking /></a> </li>
                    <li style={{ '--i': 7 }} onClick={this.activeLink}><a ><FaUsers /></a> </li>
